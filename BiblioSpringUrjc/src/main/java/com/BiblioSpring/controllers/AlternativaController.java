...
*/
	...
	public String peliculaBorrada(Model model, HttpServletRequest request, HttpSession usuario,
	...
	public String revistaBorrada(Model model, HttpServletRequest request, HttpSession usuario,
			@RequestParam String nombre) {
	...
	public String fanzineBorrado(Model model, HttpServletRequest request, HttpSession usuario,
			@RequestParam String nombre) {
